export default [
  {
    frame: "frame1",
    id: "question1",
    activeTimestamp: 117.529845,
    onContinueTimestamp: 118.719497,
    text:
    ...
    options: [
      ...
      },
      {
        ...
        label: "The values of <i>O</i> and <i>E</i> are far apart, so the values of square of (O minus E) will be small and the chi-square test statistic will be small.",
        description: "Try again.",
      ...
      },
      {
        ...
        label: "The values of <i>O</i> and <i>E</i> are close together, so the values of square of (O minus E) will be small and the chi-square test statistic will be small.",
        description: false,
      },
      {
        id: "optd",
        ...
        label: "The values of <i>O</i> and <i>E</i> are close together, so the values of square of (O minus E) will be small and the chi-square test statistic will be large.",
        description: "Try again.",
      },
    ],
  },
  {
    frame: "frame2",
    id: "question2",
    activeTimestamp: 120.551582,
    onContinueTimestamp: 121.585219,
    ...
    questionLabel: "In a goodness-of-fit test, which of the following describes a correct relationship between the  chi-square test statistic and the <i>P</i>-value?",
    correctAnswer: "opta",
    options: [
      {
        id: "opta",
        text:
          "If the test statistic is large, the P-value is small.",
        label: "",
        description: false,
      },
      {
        id: "optb",
        text:
          "If the test statistic is large, the P-value is large.",
        label:
          "",
        description: "Try again.",
      },
      {
        id: "optc",
        text:
          "If the test statistic is small, the P-value is small.",
        label:
          "",
        description: "Try again.",
      },
      {
        id: "optd",
        text: "If the test statistic is negative, the P-value is small.",
        label: "",
        description: "Try again.",
      },
    ],
  },
  {
    frame: "frame3",
    id: "question3",
    activeTimestamp: 123.099196,
    onContinueTimestamp: 124.161594,
    text:
    ...
    options: [
      {
        id: "opta",
        text: "If the P-value is large, there does not appear to be a good fit with the claimed distribution.",
        label: "",
        description: "Try again.",
      },
      {
        id: "optb",
        text: "If the P-value is large, there does appear to be a good fit with the claimed distribution",
        label: "",
        description: false,
      },
      {
        id: "optc",
        text: "If the P-value is small, there appears to be a good fit with the claimed distribution",
        label: "",
        description: "Try again.",
      },
