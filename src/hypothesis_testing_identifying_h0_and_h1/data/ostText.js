...
export default [
 ...
 {
    id: "ost7",
    startTime: 114.069136,//+2sec after 1.32
    middleTime: 121.928135,
    endTime: 142.892749,//+3sec after 2.06
    text: '<div class="option"><ul><li>Original claim:<br><i><em>p</em></i> < 0.05</li></ul></div>',
    transform:true
  },
  {
    id: "ost8",
    startTime: 122.55977,//+2sec after 1.32
    middleTime: 126.03706,
    endTime: 142.892749,//+3sec after 2.06
  ...
  },
 {
    ...
    startTime:  126.313706,//+2sec after 1.32
    endTime: 142.807789,//+3sec after 2.06
  ...
  {
    id: "ost9incorrect", 
    startTime: 131.307856, //+3sec after 2.06
    endTime: 142.787789,
    text: "<div class='incorrect message'><span class='icon'></span><p>INCORRECT.</p></div>",
  },
  {
    id: "ost9try",
    startTime: 131.307856,
    endTime: 142.787789,
    text: "<h2>TRY AGAIN.</h2>",
  },
  {
    id: "ost9hint",
    startTime: 134.415710,
    middleTime: 142.255263,
    endTime: 142.787789,
  ...
  {
    id: "ost9correct",
    startTime: 142.807789,
    endTime: 160.933562,//+2sec 
    label:"  ",
    text: "<div class='correct message'><span class='icon'></span><p>CORRECT!</p></div>",
  },
  {
    id: "ost10",
    startTime: 145.035712,
    middleTime: 150.920457,
    endTime: 193.646254, //+2sec
    text: '<div class="option"><ul><li>Alternative hypothesis (<em>H</em><sub>1</sub>):<br><i><em>p</em></i> < 0.05</li></ul></div>',
    transform:true
  },
  {
    id: "ost9correctfeedback",
    startTime: 151.799310,//69.482824,
    middleTime: 158.3599925,
    endTime: 160.933562, //+2sec 
  ...
  {
    id: "ost11hint",
    startTime: 173.359854,
    middleTime: 178.724478,
    endTime: 179.40966,
  ...
  },
  {
    ...
    startTime: 185.827084,//69.482824,
    middleTime: 190.774226,
    endTime: 193.646254, //+1sec 
    text: `<div class="option"><ul><li>The symbolic expression that uses the equal sign is the null hypothesis.</li></ul></div>`,
    transform:true
  },
  {
    id: "ost12",
    startTime: 194.600161,
    middleTime: 196.599795,
    endTime: 196.599795,
   ...
   {
    id: "ost12_2",
    startTime: 208.232536,
    middleTime:213.925794,
    endTime: 237.357973,
    text: '<div class="option"><ul><li>Express the null hypothesis (<em>H</em><sub>0</sub>) using ONLY the equal <span class="nowrap">sign (=)</span>.</li></ul></div>',
    transform:true
  },
 {
    id: "ost13",
    startTime: 214.974271,
    middleTime:220.656801,
    endTime: 237.357973,
    text:  `<div class="option">
              <ul>
                <li>
  ...
  {
    id: "ost15",
    startTime: 227.413267,//228.406135,
    endTime: 237.357973,
    text:'',
