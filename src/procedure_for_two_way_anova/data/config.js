		...
		textNode: [
			{
				...
				highlightStartTime2: 220.746405,
				highlightEndTime2: 227.281076,
				highlightStartTime3: 92.393207,
				highlightEndTime3: 106.195689,
				textNode: [],
				background: '#EFFBFF',
				border: '#00749B',
			},
				...
				textNode: [
					{
						...
						label: 'Yes Reject H sub 0 of no interaction effect.',
						classes: ['condition-node', 'column'],
						textNode: [],
					},
					{
						endTime: 152.463764,
						startTime: 128.822668,
						highlightStartTime: 23.220182,
						highlightEndTime: 35.040714,
						glow: true,
				...
				textNode: [
					{
						...
						label: 'No Fail to reject H sub 0 of no interaction effect.',
						classes: ['condition-node', 'row'],
						hiddenStart: 128.82585,
						hiddenEnd: 152.463764,
					},
					{
						textNode: [],
						endTime: 184.98376, // 1 sec not added
						startTime: 153.201929,
						highlightStartTime: 35.040714,
						highlightEndTime: 50.869823,
						highlightStartTime2: 229.836805,
						highlightEndTime2: 235.482202,
						glow: true,
...
export const nodeTimestamp = [
	...
	},
	{
		id: 'whole-number-yes-child',
		endTime: 150.02158,
		startTime: 129.404637,
	},
	{
		id: 'whole-number-no-child',
		endTime: 186.219889,
		startTime: 153.477854,
	},
	{
		id: 'left-child',
		endTime: 212.24835,
		startTime: 187.216011,
	},
	{
		id: 'chart-start',
		endTime: 216.208506,
		startTime: 249.693061,
	},
];
...
export const altText = {
	...
	activityTitle:
    "A flowchart explains the procedure of two way analysis of variance.",
	caption: {
