...
const ChartActivity = (props) => {
  ...
  const classes = (uid, baseClasses) => {
    ...
    if (props.selectAll) {
      ...
      const getValueDiv = ref && ref.current && ref.current.querySelectorAll(".additional-value"); // hide additionall added arrow pointing to right & left child
  ...
  const onBranchClick = (e) => {
    ...
    const getButtonId = props.timestampsForAttempts[branch].filter((e) => e.startTime <= currentTime && e.endTime > currentTime)[0];
  ...
  useEffect(() => {
    ...
    const getButtonDiv = buttonNode.filter((e) => e.startTime <= currentTime && e.endTime > currentTime)[0];
  ...
  const onStart = () => {
    ...
    // alert(currentTime)
    if (getButtonDiv) {
      props.updateCurrentTime(getButtonDiv.endTime + .250)
        ...
        <div>
          <div className="node start">
            <div className="node-container">
              ...
              <div className={`text startend chart-start ${startButton ? 'glow' : ''}`} id="chart-start">
                {startButton ? <button className="heading" onClick={onStart}>Start</button> : <p className="heading">Start</p>}


              </div>

              <div className={classes("startarrow", "startarrow arrow")} aria-hidden="true"></div>
            </div>
          </div>
          <div className="children typeoftest">
            ...
            >
              <div className={classes("typeoftest", "decision-box typeoftest")}>
                <div className="text decision" id="typeoftest">
                  <p className="heading">What type of test?</p>
                </div>
              </div>
              <div
                className={classes("right-tailed", "right-tailed node-container")}
              >
                <div className={classes("right-tailed-arrow", "right-tailed-arrow right-tailed decision-arrow right right-tailed-arrow")}>
                ...
                <div className="right-tailed-child">
                  ...
                  <div
                    ...
                    // aria-labelledby="right-tailed-btn"
                  >
                    <div
                      tabIndex="-1"
                      id="node-right-tailed"
                    ...
                    >
                      <p className="heading">
                        ...
                        <span aria-hidden="true">
                          <em>P</em>-value = area to the right of the test statistic
                    </span>
                      </p>
                    </div>
                    <div className="drawing drawing2">
                      ...
                      <div className="drawing2"></div>
                      <div className="text-bottom right">
                        <span className="text">Test statistic</span>
                        <div className="arrow-img right" aria-hidden="true" dangerouslySetInnerHTML={{ __html: arrowSvg }}>
                          {/* {arrowSvg} */}
                        </div>
                      </div>
                    </div>
                    <div className={classes("glowing-right-child", "glowing-right-child glow-arrow ")}>
                    </div>
                  </div>
                </div>
              </div>
              <div className={classes("left-tailed", "left-tailed node-container")}>
                <div className={classes("left-tailed-arrow", "left-tailed-arrow left-tailed decision-arrow left left-tailed-arrow")}>
                  <button
                    type="button"
                    title="Left tailed"
                ...
                <div className="left-tailed-child">
                  ...
                  <div
                    className="process-container"
                    // aria-labelledby="left-tailed-btn"
                  >
                    <div
                      tabIndex="-1"
                      id="node-left-tailed"
                    ...
                    >
                      ...
                      p value = area to the left of the test statistic
                        ...
                        <span aria-hidden="true">
                          <em>P</em>-value = area to the left of the test statistic
                    </span>
                      </p>
                    </div>
                    <div className="drawing left">
                      ...
                      <div className="text-bottom left">
                        <div className="arrow-img left" aria-hidden="true" dangerouslySetInnerHTML={{ __html: arrowSvg }} aria-hidden="true"></div>
                        <span className="text">Test statistic</span>
                      </div>
                    </div>
                    <div className={classes("glowing-left-child", "glowing-left-child glow-arrow")}>
                    </div>
                  </div>
                </div>
              </div>
              <div className={classes("two-tailed-arrow", "tow-tailed-arrow two-tailed bottom-arrow-container")}>
                <div className="decision-arrow bottom"></div>
                <button
                  type="button"
                  title="Two tailed"
                  data-key="two-tailed"
            ...
            >
              <div className="node two-tailed-child">
                ...
                <div
                  className={classes("right-child", "node-container right-child")}
                >
                  <div className="decision-arrow right">
                    <p id="right-child-text">Right</p>
                  </div>
                  <div className="two-tailed-right">
                    <div className="arrow"></div>
                    <div
                      className="process-container  right"
                    ...
                    >
                      ...
                      >
                        <p className="heading">
                          ...
                          <span aria-hidden="true">
                            <em>P</em>-value = twice the area to the right of the
                        test statistic{" "}
                          </span>
                        </p>
                      </div>
                      <div className="drawing">
                        <div className="text-top right sm">
                          <span>
                            <span className="sr-only">
                              p value is twice this area.
                        </span>
                            <span aria-hidden="true">
                              <em>P</em>-value is twice this area.
                        </span>
                          </span>
                          <span className="line" aria-hidden="true"></span>
                        </div>
                        ...
                        <div className="text-bottom right">
                          <span className="text">Test statistic</span>
                          <div className="arrow-img right" aria-hidden="true" dangerouslySetInnerHTML={{ __html: arrowSvg }}></div>
                        </div>
                        <div className="additional-value right">
                          <div className={classes("drawing-right-value1", "value-container")}>
                            <div className="arrow"></div>
                            <div className="text"><span>0.03</span></div>

                          </div>
                          <p className={classes("drawing-right-value2", "value-bottom")}>P-value=0.06</p>
                        </div>
                      </div>
                      <div className={classes("glowing-two-child", "glowing-two-child glow-arrow right")}>
                      </div>
                    </div>
                  </div>
                </div>

                <div className={classes("left-child", "node-container left-child")}>
                  <div className="decision-arrow left">
                    <p id="left-child-text">Left</p>
                  </div>
                  <div className="two-tailed-left">
                    <div className="arrow"></div>
                    <div
                      className="process-container left"
                    ...
                    >
                      ...
                      >
                        <p className="heading">
                          <span aria-hidden="true">
                            <em>P</em>-value = twice the area to the left of the
                        test statistic
                      </span>
                          <span className="sr-only">
                      ...
                      <div className="drawing left">
                        <div className="text-top left sm">
                          <span>
                            <span aria-hidden="true">
                              <em>P</em>-value is twice this area.
                        </span>
                        ...
                        <div className="drawing1"></div>
                        <div className="text-bottom left">
                          <div className="arrow-img left" aria-hidden="true" dangerouslySetInnerHTML={{ __html: arrowSvg }}></div>
                          <span className="text">Test statistic</span>
                        </div>
                        <div className="additional-value left">
                          <div className={classes("drawing-left-value1", "value-container")}>
                            <div className="arrow"></div>
                            <div className="text"><span>0.03</span></div>

                          </div>
                          <p className={classes("drawing-left-value2", "value-bottom")}>P-value=0.06</p>
                        </div>
                      </div>
                      <div className={classes("glowing-two-child", "glowing-two-child glow-arrow left")}>
                      </div>
                    </div>
                  </div>
                </div>
